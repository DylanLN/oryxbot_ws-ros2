...
using DeleteModel = gazebo_msgs::srv::DeleteModel; rclcpp::Node::SharedPtr g_node = nullptr;
...
int main(int argc, char ** argv)
{
    ...
    auto server = g_node->create_service<DeleteModel>("/gazebo/delete_model", handle_service);
    rclcpp::spin(g_node); 
    rclcpp::shutdown(); 
    g_node = nullptr;
    return 0;
